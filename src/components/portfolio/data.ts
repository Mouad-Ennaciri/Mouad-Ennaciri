export const navLinks = ["About", "Skills", "Projects", "Journey", "Contact"];

export const headlineLines = ["I Build Interfaces", "People Remember."];

export const socialLinks = [
  { label: "GitHub", href: "https://github.com/Mouad-Ennaciri", icon: "mdi:github" },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/mouadennaciri-/", icon: "mdi:linkedin" },
  { label: "Email", href: "mailto:ennacirimouade1@gmail.com", icon: "mdi:email-outline" },
];
...
export const highlights = [
  ["mdi:map-marker", "Marrakech, Morocco"],
  ["mdi:monitor-dashboard", "React & Next.js Specialist"],
  ["mdi:school-outline", "100% Self-Taught"],
  ["mdi:weather-night", "Dark Mode Lover"],
  ["mdi:rocket-launch-outline", "Open to Opportunities"],
];
...
export const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      ["ScrollTrigger", "mdi:gesture-tap-hold"],
      ["CSS Animations", "mdi:animation-play-outline"],
    ],
  },
  {
    title: "TOOLS",
...
export const journey = [
  ...
  {
    year: "2025",
    phase: "Animations Obsession",
    title: "Discovered GSAP",
    description:
      "Stumbled upon GSAP and became completely obsessed. Learned ScrollTrigger, timelines, and the art of making interfaces feel alive. Animation and motion design became my signature style.",
  },
  {
    year: "2025",
    phase: "Level Up",
...
export const directContact = [
  ["mdi:email-outline", "Email", "ennacirimouade1@gmail.com"],
  ["mdi:cellphone", "Phone", "+212 707820932"],
  ["mdi:map-marker", "Location", "Marrakech, Morocco"],
  ["mdi:earth", "Available for", "Remote work worldwide"],
];
